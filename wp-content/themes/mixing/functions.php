...
add_action('wp_enqueue_scripts', '_jqeury');
function _jqeury()
{
    wp_enqueue_script('jquery_3', get_template_directory_uri() . "/assets/jquery/jquery-3.3.0.min.js", array(), true);
    wp_enqueue_script('jqueryUI_js', get_template_directory_uri() . "/assets/jquery/jquery-ui.min.js", array(), true);
    ...
    wp_enqueue_script('ognamjs', get_template_directory_uri() . "/assets/js/ognam.js", array(), true);
    wp_enqueue_script('fancybox', get_template_directory_uri() . "/assets/fancybox/jquery.fancybox.min.js", array(),true);
}
